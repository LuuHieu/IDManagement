 ...
 *******************************************************************************/
package com.prdcv.iot.android.app.utils;
...
import com.prdcv.iot.android.app.activities.ProfilesActivity;
import com.prdcv.iot.android.app.fragments.IoTPagerFragment;
import com.prdcv.iot.android.app.fragments.LogPagerFragment;
import com.prdcv.iot.android.app.fragments.LoginPagerFragment;
...
public class MessageConductor {
    ...
    public void steerMessage(String payload, String topic) throws JSONException {
        ...
        if (topic.contains(Constants.COLOR_EVENT)) {
            ...
            Intent messageIntent = new Intent(Constants.APP_ID + Constants.INTENT_IOT);
            messageIntent.putExtra(Constants.INTENT_DATA,Constants.TEXT_EVENT);
            messageIntent.putExtra(Constants.URLS_ID,messageText);
//            messageIntent.putExtra(Constants.TEXT_EVENT,messageText);
