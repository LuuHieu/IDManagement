...
package com.prdcv.iot.android.app.cloudservice;
...
public class StorageServiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = StorageServiceActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.storage_service_acticvity);
...
//         Check if this Activity was launched by clicking on an upload notification
        if (intent.hasExtra(Constants.TEXT_EVENT)) {
            downloadResultIntent(intent);
        }
    ...
    public void onStart() {
        super.onStart();
        newUpdateUI(mAuth.getCurrentUser());
    ...
    //=--------------------------dathoang
    private void newBeginDownload() {
        // Get path

        String path = "photos/"+ mImageName ;
        ...
        mAuth.signInAnonymously()
                .addOnSuccessListener(this, new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        hideProgressDialog();
                        newUpdateUI(authResult.getUser());
                    }
                })
    ...
    //    -------------------dathoang
    private void downloadResultIntent(Intent intent) {
        // Got a new intent from MyUploadService with a success or failure
        String urlString = intent.getStringExtra(Constants.TEXT_EVENT);
        mDownloadUrl = Uri.parse(urlString);
        int indexBegin = urlString.indexOf("%2F");
        int indexEnd = urlString.indexOf("?") ;

        mImageName = urlString.substring(indexBegin+3,indexEnd);

        Log.e(TAG,"mDownloadUrl = "+ mDownloadUrl.toString());
        newUpdateUI(mAuth.getCurrentUser());
    }

    //    ----------------------------dathoang
    private void newUpdateUI(FirebaseUser user) {
