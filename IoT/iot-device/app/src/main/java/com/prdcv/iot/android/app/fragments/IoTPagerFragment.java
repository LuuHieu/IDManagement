 ...
 *******************************************************************************/
package com.prdcv.iot.android.app.fragments;
...
import com.prdcv.iot.android.app.IoTStarterApplication;
import com.prdcv.iot.android.app.R;
import com.prdcv.iot.android.app.cloudservice.StorageServiceActivity;
import com.prdcv.iot.android.app.iot.IoTClient;
import com.prdcv.iot.android.app.utils.Constants;
import com.prdcv.iot.android.app.utils.MessageFactory;
import com.prdcv.iot.android.app.utils.MyIoTActionListener;
import com.prdcv.iot.android.app.views.DrawingView;
...
public class IoTPagerFragment extends IoTStarterPagerFragment {
    ...
    private void processIntent(Intent intent) {
        ...
        } else if (data.equals(Constants.TEXT_EVENT)) {
//            String message = intent.getStringExtra(Constants.TEXT_EVENT);
            String message = intent.getStringExtra(Constants.URLS_ID);

            //open StorageServiceActivity
            Intent intentFireBase = new Intent(getActivity(), StorageServiceActivity.class);
            intentFireBase.putExtra(Constants.TEXT_EVENT, message);
            startActivity(intentFireBase);

            //open PhotoDownloadActivity
//            Intent intentFireBase = new Intent(getActivity(), PhotoDownloadActivity.class);
//            intentFireBase.putExtra(Constants.TEXT_EVENT, message);
//            startActivity(intentFireBase);
        }
    }
